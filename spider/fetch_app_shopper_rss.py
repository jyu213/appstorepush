...
db_freeze = db.drop_rss

APP_SHOPPER_HOST = 'http://appshopper.com'
APP_SHOPPER_DROP_LIST_URL = ['http://appshopper.com/feed/?device=iPhone&mode=featured&filter=price',
                            'http://appshopper.com/feed/?device=iPad&mode=featured&filter=price',
                            'http://appshopper.com/feed/?platform=mac&mode=featured&filter=price']
...
for url in APP_SHOPPER_DROP_LIST_URL:
    fetchData(url)
